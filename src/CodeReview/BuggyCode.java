...
public class BuggyCode {
	...
	public static void main(final String[] args) {
		...
		System.out.println("BuggyCode Sample 001 fixed for BC_IMPOSSIBLE_CAST");
		// CORRECT
		BuggyCode.bcImpossibleCastCORRECT();

		System.out.println("BuggyCode Sample 002 fixed for BC_IMPOSSIBLE_DOWNCAST");
		// CORRECT
		BuggyCode.bcImpossibleDowncastCORRECT();

		System.out.println("BuggyCode Sample 003 fixed for BC_IMPOSSIBLE_INSTANCEOF");
		// CORRECT
		BuggyCode.bcImpossibleInstanceOfCORRECT();

		System.out.println("BuggyCode Sample 004 fixed for BC_IMPOSSIBLE_DOWNCAST_OF_TOARRAY");
		// CORRECT
		BuggyCode.bcImpossibleDowncastOfArrayCORRECT();

		System.out.println("BuggyCode Sample 005 fixed for DMI_BIGDECIMAL_CONSTRUCTED_FROM_DOUBLE");
		// CORRECT
		BuggyCode.dmiBigDecimalConstructedFromDoubleCORRECT();

		System.out.println("BuggyCode Sample 006 fixed for ES_COMPARING_STRINGS_WITH_EQ");
		// CORRECT
		BuggyCode.esComparingStringsWithEqCORRECT();

		System.out.println("BuggyCode Sample 007 fixed for VA_FORMAT_STRING_ILLEGAL");
		// CORRECT
		BuggyCode.vaFormatStringIllegalCORRECT();

		System.out.println("BuggyCode Sample 008 fixed for RV_RETURN_VALUE_IGNORED");
		// CORRECT
		BuggyCode.rvReturnValueIgnoredCORRECT();

		System.out.println("BuggyCode Sample 009 fixed for NP_ALWAYS_NULL");
		// CORRECT
		BuggyCode.npAlwaysNullCORRECT();

		System.out.println("BuggyCode Sample 010 fixed for QBA_QUESTIONABLE_BOOLEAN_ASSIGNMENT");
		// CORRECT
